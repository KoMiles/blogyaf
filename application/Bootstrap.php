...
#         Desc: 引导程序,做很多全局自定义的工作,这个类也必须继承自Yaf\Bootstrap_Abstract
...
class Bootstrap extends Yaf\Bootstrap_Abstract {
    ...
    public function _initRoute(Yaf\Dispatcher $dispatcher) {
        ...
        //创建一个路由协议实例
        //$route = new Yaf\Route_Rewrite('product/:ident',array('module'=>'Index','controller' => 'Index','action' => 'test'));
        //使用路由器装载路由协议
        ///product/34
    ...
    public function _initPlugin(Yaf\Dispatcher $dispatcher) {
        ...
        //Yaf\Registry::set('adminPlugin', $admin);
    }
